...
@pytest.mark.parametrize(("question", "expected"), [
    ...
    ("What annual base salary do you expect, including all bonuses?", "year"),
    ("Annual salary expectation (top of range)", "year"),
    ("Try to state your annual salary", "year"),
    ("Base salary in PHP role annually", "year"),
